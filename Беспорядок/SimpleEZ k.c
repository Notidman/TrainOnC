...
int main()
{
    ...
    int* mass = (int*)malloc(k * sizeof(int));

    Shuffle(k, mass, 1, 1000, n);
...
void Shuffle(int arr_size, int* parr, int range_min, int range_max, int gen) {
    srand(time(NULL));
